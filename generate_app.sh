...
echo "🚀 MERDOLDA APP (FIXED) OLUŞTURULUYOR..."
...
# 2. PROGUARD (Eksik dosyayı oluşturuyoruz)
touch $MODULE_DIR/proguard-rules.pro

# 3. SETTINGS.GRADLE (Gradle 9 Uyumlu)
...
# 5. BUILD.GRADLE (APP LEVEL - Fixed Dependencies)
...
# 6. KAYNAK DOSYALAR (Resources) - Eksik olanlar eklendi

# strings.xml
cat << 'EOF' > $RES_DIR/values/strings.xml
<resources>
    <string name="app_name">Merdolda TV</string>
</resources>
EOF

# themes.xml (Eksikti, hata veriyordu)
cat << 'EOF' > $RES_DIR/values/themes.xml
<resources>
    <style name="Theme.Merdolda" parent="Theme.AppCompat.NoActionBar">
...
# ic_launcher.xml (Vektör İkon - Resim dosyası hatasını önler)
...
# 7. MANIFEST (Tema ve İkon Güncellendi)
...
<manifest xmlns:android="http://schemas.android.com/apk/res/android">
    ...
    <application
        ...
        android:theme="@style/Theme.Merdolda"
...
# 8. JAVA DOSYALARI (Aynen korundu)
...
echo "✅ DOSYALAR EKSİKSİZ HAZIRLANDI."
