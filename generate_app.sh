...
# --- 1. PROJE AYARLARI (HATA BURADAYDI, DÜZELTİLDİ: "theapp" OLARAK SABİTLENDİ) ---
...
echo "💎 ERDINPLAYER ULTIMATE v14.0: SİSTEM SIFIRDAN İNŞA EDİLİYOR (FULL CODEBASE)..."

# --- 2. TEMİZLİK VE KLASÖR OLUŞTURMA ---
if [ -d "$PROJECT_ROOT" ]; then rm -rf "$PROJECT_ROOT"; fi

mkdir -p "$PKG_DIR"/{model,adapter,api,utils,ui}
mkdir -p "$RES_DIR"/{layout,values,drawable,anim,menu,color,mipmap-anydpi-v26}
mkdir -p "$PROJECT_ROOT/gradle/wrapper"

# --- 3. KEYSTORE (İMZA OLUŞTURMA) ---
...
<resources>
    <style name="AppTheme" parent="Theme.MaterialComponents.NoActionBar">
        ...
        <item name="android:navigationBarColor">@color/sidebar_bg</item>
    </style>
    <style name="SidebarText">
...
# Drawables (Arka Planlar & İkonlar)
cat << 'EOF' > "$RES_DIR/drawable/bg_glass.xml"
<shape xmlns:android="http://schemas.android.com/apk/res/android"><solid android:color="#1AFFFFFF"/><corners android:radius="10dp"/><stroke android:width="1dp" android:color="#33FFFFFF"/></shape>
EOF
cat << 'EOF' > "$RES_DIR/drawable/bg_btn_accent.xml"
<shape xmlns:android="http://schemas.android.com/apk/res/android"><solid android:color="@color/accent"/><corners android:radius="10dp"/></shape>
EOF
...
<vector xmlns:android="http://schemas.android.com/apk/res/android" android:width="32dp" android:height="32dp" android:viewportWidth="24" android:viewportHeight="24"><path android:fillColor="#FFF" android:pathData="M18,4l2,4h-3l-2,-4h-2l2,4h-3l-2,-4h-2l2,4h-3l-2,-4h-2l2,4h-3l-2,-4H1v16h22V4H18z"/></vector>
EOF
cat << 'EOF' > "$RES_DIR/drawable/ic_exit.xml"
<vector xmlns:android="http://schemas.android.com/apk/res/android" android:width="32dp" android:height="32dp" android:viewportWidth="24" android:viewportHeight="24"><path android:fillColor="#FF5722" android:pathData="M10.09,15.59L11.5,17l5,-5l-5,-5l-1.41,1.41L12.67,11H3v2h9.67L10.09,15.59zM19,3H5C3.9,3 3,3.9 3,5v4h2V5h14v14H5v-4H3v4c0,1.1 0.9,2 2,2h14c1.1,0 2,-0.9 2,-2V5C21,3.9 20.1,3 19,3z"/></vector>
EOF
...
public class AppModels {
    public static class Playlist implements Serializable {
        ...
        public String m3uContent; // For local storage
    }
...
# --- 7. M3U PARSER (HEADER & ORIGIN DESTEĞİ) ---
...
public class PrefUtils {
    private static SharedPreferences get(Context c) { return c.getSharedPreferences("ULTIMATE_V14", 0); }
...
<LinearLayout xmlns:android="http://schemas.android.com/apk/res/android" android:layout_width="match_parent" android:layout_height="match_parent" android:orientation="horizontal" android:background="@color/bg_main">
    <LinearLayout android:layout_width="80dp" android:layout_height="match_parent" android:orientation="vertical" android:background="@color/sidebar_bg" android:gravity="center_horizontal" android:paddingTop="30dp">
        <ImageView android:id="@+id/btnLive" android:layout_width="50dp" android:layout_height="50dp" android:src="@drawable/ic_tv" android:padding="10dp" android:background="?attr/selectableItemBackground" android:layout_marginBottom="20dp"/>
        <ImageView android:id="@+id/btnMovies" android:layout_width="50dp" android:layout_height="50dp" android:src="@drawable/ic_movie" android:padding="10dp" android:background="?attr/selectableItemBackground" android:layout_marginBottom="20dp"/>
        <View android:layout_width="match_parent" android:layout_height="0dp" android:layout_weight="1"/>
        <ImageView android:id="@+id/btnLogout" android:layout_width="50dp" android:layout_height="50dp" android:src="@drawable/ic_exit" android:padding="10dp" android:background="?attr/selectableItemBackground" android:layout_marginBottom="20dp"/>
    </LinearLayout>
...
<LinearLayout xmlns:android="http://schemas.android.com/apk/res/android" android:layout_width="match_parent" android:layout_height="match_parent" android:background="@color/bg_main" android:orientation="vertical" android:padding="20dp" android:gravity="center">
    <TextView android:layout_width="wrap_content" android:layout_height="wrap_content" android:text="PLAYLISTS" android:textColor="#FFF" android:textSize="24sp" android:textStyle="bold" android:layout_marginBottom="20dp"/>
...
<LinearLayout xmlns:android="http://schemas.android.com/apk/res/android" android:layout_width="match_parent" android:layout_height="match_parent" android:background="@color/bg_main" android:orientation="vertical" android:padding="30dp" android:gravity="center">
    ...
    <EditText android:id="@+id/etUrl" android:layout_width="match_parent" android:layout_height="100dp" android:hint="M3U URL or Paste Content" style="@style/GlassInput" android:gravity="top" android:layout_marginBottom="20dp"/>
    <Button android:id="@+id/btnSave" android:layout_width="match_parent" android:layout_height="60dp" android:text="DOWNLOAD &amp; SAVE" android:background="@drawable/bg_btn_accent" android:textColor="#FFF"/>
</LinearLayout>
EOF
...
# LoginActivity (Smart Logic for Xtream/M3U)
...
public class LoginActivity extends AppCompatActivity {
    @Override protected void onCreate(Bundle s) {
        ...
        findViewById(R.id.btnSave).setOnClickListener(v -> {
            ...
            // Eğer yapıştırılan metin #EXTINF içeriyorsa direkt kaydet (Raw Content)
            if(url.contains("#EXTINF")) {
                save(name, url, "M3U");
            } else {
                // Link ise indirmeyi dene
                new Thread(() -> {
                    try {
                        ...
                        runOnUiThread(() -> Toast.makeText(this, "Failed to download playlist", 0).show());
                    }
                }).start();
            }
        });
...
# DashboardActivity (Sidebar Logic)
...
# PlayerActivity (Header Injection & Immersive)
...
public class PlayerActivity extends AppCompatActivity {
    ...
    @Override protected void onCreate(Bundle s) {
        super.onCreate(s);
        // IMMERSIVE MODE (Bildirim çubuğunu gizle)
        ...
        f.setUserAgent("Mozilla/5.0 (Windows NT 10.0; Win64; x64)"); // Browser gibi davran
...
echo "✅ ERDINPLAYER v14.0: PROJECT ROOT FIXED (theapp) & FULL SYSTEM READY."
