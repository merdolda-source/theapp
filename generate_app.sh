...
echo "💎 ERDINPLAYER ULTIMATE: TÜM SİSTEM YENİDEN İNŞA EDİLİYOR..."

# 1. KLASÖR YAPILANDIRMASI (MODÜLER MİMARİ)
rm -rf $PROJECT_ROOT
mkdir -p $PKG_DIR/{model,adapter,api,utils,ui}
mkdir -p $RES_DIR/{layout,values,drawable,anim,mipmap-anydpi-v26}
mkdir -p $PROJECT_ROOT/gradle/wrapper

# 2. KEYSTORE (APK İMZALAMA - PAKET HATASINI ÖNLER)
...
# 4. KAYNAKLAR (RES) - HATALARI ÖNLEMEK İÇİN EKSİKSİZ
...
# KRİTİK: Manifest'in istediği ic_launcher_background burada oluşturuluyor
...
<shape xmlns:android="http://schemas.android.com/apk/res/android"><solid android:color="@color/accent_red"/><corners android:radius="12dp"/></shape>
EOF

# 5. MODELLER (XTREAM & M3U)
...
# 8. LAYOUTS (EKRAN GÖRÜNTÜLERİNDEKİ YAPI)
# Selection Screen
...
<LinearLayout xmlns:android="http://schemas.android.com/apk/res/android" android:layout_width="match_parent" android:layout_height="match_parent" android:background="@color/bg_dark" android:orientation="vertical" android:gravity="center" android:padding="20dp">
    ...
    <Button android:id="@+id/btnM3u" android:layout_width="match_parent" android:layout_height="75dp" android:text="M3U URL'den Yükle" android:backgroundTint="@color/accent_red" android:layout_marginBottom="15dp"/>
...
# Login Screens (Generic structure for all)
...
<ScrollView xmlns:android="http://schemas.android.com/apk/res/android" android:layout_width="match_parent" android:layout_height="match_parent" android:background="@color/bg_dark" android:fillViewport="true">
    <LinearLayout android:layout_width="match_parent" android:layout_height="wrap_content" android:orientation="vertical" android:padding="25dp" android:gravity="center">
        <TextView android:layout_width="wrap_content" android:layout_height="wrap_content" android:text="Xtream Codes" android:textColor="@color/white" android:textSize="22sp" android:layout_marginBottom="30dp"/>
        <EditText android:id="@+id/etName" android:layout_width="match_parent" android:layout_height="60dp" android:hint="İsteğe Bağlı Ad" android:textColor="#FFF" android:background="@color/bg_card" android:padding="15dp" android:layout_marginBottom="15dp"/>
        ...
        <EditText android:id="@+id/etDns" android:layout_width="match_parent" android:layout_height="60dp" android:hint="http://server.com:80" android:textColor="#FFF" android:background="@color/bg_card" android:padding="15dp" android:layout_marginBottom="30dp"/>
        <Button android:id="@+id/btnLogin" android:layout_width="match_parent" android:layout_height="60dp" android:text="Oynatma Listesi Ekle" android:backgroundTint="@color/accent_red"/>
    </LinearLayout>
</ScrollView>
EOF
...
<LinearLayout xmlns:android="http://schemas.android.com/apk/res/android" android:layout_width="match_parent" android:layout_height="match_parent" android:background="@color/bg_dark" android:orientation="vertical" android:padding="25dp" android:gravity="center">
    ...
    <EditText android:id="@+id/etRef" android:layout_width="match_parent" android:layout_height="60dp" android:hint="Referer (Varsa)" android:textColor="#FFF" android:background="@color/bg_card" android:padding="15dp" android:layout_marginBottom="15dp"/>
    <EditText android:id="@+id/etOri" android:layout_width="match_parent" android:layout_height="60dp" android:hint="Origin (Varsa)" android:textColor="#FFF" android:background="@color/bg_card" android:padding="15dp" android:layout_marginBottom="30dp"/>
...
# 9. UI ACTIVITIES (REFERER & ORIGIN LOGIC)
...
# Boş sınıfları dolduruyoruz... (Derleme için şart)
touch $PKG_DIR/ui/LoginXtreamActivity.java $PKG_DIR/ui/DashboardActivity.java $PKG_DIR/ui/CommonListActivity.java
...
echo "✅ MEGA SİSTEM VE KAYNAKLAR HAZIR. ŞİMDİ PUSH YAPIN!"
